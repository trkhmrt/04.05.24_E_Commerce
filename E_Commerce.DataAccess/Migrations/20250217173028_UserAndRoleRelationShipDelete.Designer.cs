...
namespace E_Commerce.DataAccess.Migrations
{
    ...
    [Migration("20250217173028_UserAndRoleRelationShipDelete")]
    partial class UserAndRoleRelationShipDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("E_Commerce.DataAccess.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("RoleUsersuserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Commerce.DataAccess.Entities.Role", null)
                        .WithMany()
